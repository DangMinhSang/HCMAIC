...
def index():
    ...
    return render_template_string(
        PAGE,
        api_search=url_for("search"),
        api_export=url_for("export"),
        api_health=url_for("health"),
    )
